          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {themes.map(t => (
              <div 
                ...
                className={`border-2 rounded-2xl p-4 cursor-pointer transition-all relative ${business.theme === t.id ? 'border-pink-500 bg-pink-50' : 'border-slate-100 hover:border-slate-300'}`}
              >
                {business.theme === t.id && (
                  <div className="absolute -top-3 -right-3 bg-pink-500 text-white rounded-full p-1 border-2 border-white shadow-sm">
