    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6 pb-12">
        <div className="flex items-center justify-between">
          ...
          <Button onClick={handleAddProduct} variant="primary" className="rounded-xl px-6 bg-[#111111] hover:bg-[#111111] border-none shadow-md" disabled={submitting}>
        ...
        <form id="productForm" onSubmit={handleAddProduct} className="space-y-6">
              ...
              <div className="flex flex-col items-center">
                <div className="w-40 h-40 rounded-2xl border-2 border-dashed border-slate-600 bg-black/50 overflow-hidden relative flex flex-col items-center justify-center text-center p-2 group hover:border-[#111111]/50 transition-colors mb-6">
                  {formData.image ? (
                    ...
                    <>
                      <ImageIcon className="w-8 h-8 text-slate-500 mb-2 group-hover:text-[#111111]" />
                ...
                {uploadingImage && <p className="text-xs text-[#111111] mt-2 font-bold animate-pulse">Optimizing image...</p>}
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="bg-[#1A1A1A] p-6 rounded-3xl border border-slate-800 shadow-xl space-y-5">
              ...
              <div className="flex justify-between items-end mb-1.5">
                <label className="text-sm font-bold text-white">Name <span className="text-[#111111]">*</span></label>
                <button onClick={handleAIGenerate} disabled={generatingAI} className="text-xs font-extrabold text-blue-400 bg-[#111111]/10 px-2.5 py-1 rounded-lg flex items-center gap-1 hover:bg-[#111111]/20 transition-colors">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-bold text-white mb-1.5 block">Delivery <span className="text-[#111111]">*</span></label>
                    <select required value={formData.delivery_type} onChange={(e: any) => setFormData({...formData, delivery_type: e.target.value})} className="w-full bg-black/50 border border-slate-700 text-white h-12 rounded-xl px-4 outline-none focus:border-[#111111] focus:ring-1 focus:ring-[#111111]/50 appearance-none">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-[#1A1A1A] p-6 rounded-3xl border border-slate-800 shadow-xl space-y-5">
              ...
              <div>
                <label className="text-sm font-bold text-white mb-1.5 block">Stock <span className="text-[#111111]">*</span></label>
          ...
          <div className="space-y-2">
            ...
            <div className="bg-[#1A1A1A] p-6 rounded-3xl border border-slate-800 shadow-xl space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button type="button" onClick={() => setFormData({...formData, published: !formData.published})} className={`w-12 h-6 rounded-full transition-colors relative ${formData.published ? 'bg-[#111111]' : 'bg-slate-700'}`}>
              ...
              <div className="flex items-center justify-between">
                ...
                <button type="button" onClick={() => setFormData({...formData, featured: !formData.featured})} className={`w-12 h-6 rounded-full transition-colors relative ${formData.featured ? 'bg-[#111111]' : 'bg-slate-700'}`}>
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button variant="primary" className="font-bold rounded-xl shadow-md bg-[#111111] hover:bg-[#111111] border-none" onClick={() => setShowAddForm(true)}>
      ...
      {products.length === 0 ? (
        <div className="bg-white rounded-3xl border border-slate-200 p-12 text-center shadow-sm">
          <div className="w-16 h-16 bg-slate-100 text-[#111111] rounded-2xl flex items-center justify-center mx-auto mb-4">
          ...
          <Button variant="primary" className="font-bold rounded-xl bg-[#111111] hover:bg-[#111111] border-none" onClick={() => setShowAddForm(true)}>
            <Plus className="w-4 h-4 mr-2" /> Add Product
          </Button>
        </div>
      ) : (
            ...
            <div key={p.id} className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center gap-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex sm:flex-col gap-2 w-full sm:w-auto mt-4 sm:mt-0 border-t sm:border-t-0 sm:border-l border-slate-100 pt-4 sm:pt-0 sm:pl-4">
                <button 
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 text-xs font-bold text-slate-500 hover:text-[#111111] py-1 px-2 rounded-lg hover:bg-slate-100 transition-colors"
                >
