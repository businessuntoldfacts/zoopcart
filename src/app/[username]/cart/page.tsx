    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-20">
      ...
      <header className="bg-white px-4 h-16 flex items-center justify-between sticky top-0 z-50 border-b border-slate-100 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full overflow-hidden bg-slate-100 border border-slate-200 shrink-0">
            {business.profile_image ? (
              ...
              <div className="w-full h-full flex items-center justify-center bg-slate-100 text-[#111111] font-bold text-lg">
        ...
        <div className="flex items-center gap-4">
          <Link href={`/${business.username}/saved`} className="text-slate-600 hover:text-[#111111] transition-colors">
            <Heart className="w-6 h-6" />
          </Link>
          <Link href={`/${business.username}/cart`} className="w-10 h-10 bg-[#111111] hover:bg-black text-white rounded-xl flex items-center justify-center shadow-md transition-colors relative">
      ...
      <div className="max-w-md mx-auto bg-white min-h-[calc(100vh-64px)] relative shadow-sm border-x border-slate-100 p-6 flex flex-col items-center">
        ...
        <div className="w-full flex items-center gap-2 text-sm font-bold text-[#111111] mb-6">
        ...
        <div className="w-full bg-slate-50 rounded-[32px] border border-slate-100 p-8 flex flex-col items-center text-center">
           ...
           <Link href={`/${business.username}`}>
             <Button className="h-12 px-8 rounded-xl bg-[#111111] hover:bg-black text-white font-extrabold shadow-md shadow-black/20 border-none">
               Continue Shopping
             </Button>
           </Link>
        </div>
