    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-32 relative">
      ...
      <header className="fixed top-0 w-full z-50 flex items-center justify-between px-4 h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-full bg-white/80 text-pink-500 backdrop-blur-md shadow-sm border border-slate-100/50">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 z-50 p-4 pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.06)]">
          <div className="max-w-md mx-auto">
            <Link href={`/${business.username}/${product.slug}/request`}>
              <button className="w-full h-14 rounded-2xl bg-pink-500 hover:bg-pink-600 text-white font-extrabold text-lg flex items-center justify-center gap-2 shadow-lg shadow-pink-500/30 transition-all active:scale-[0.98]">
