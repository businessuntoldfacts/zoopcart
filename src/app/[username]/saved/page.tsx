    ...
    <div className="min-h-screen bg-white font-sans pb-24">
      ...
      <div className="max-w-md mx-auto px-6 pt-24 pb-12 flex flex-col items-center text-center">
         <div className="w-32 h-32 rounded-full bg-pink-50 flex items-center justify-center mb-8 relative">
           ...
           <Heart className="w-12 h-12 text-pink-500 relative z-10" strokeWidth={2.5} />
         </div>
         ...
         <Link href={`/${business.username}`}>
           <button className="px-8 py-3.5 bg-pink-500 hover:bg-pink-600 text-white font-extrabold rounded-2xl shadow-sm transition-colors text-sm">
             Explore Products
           </button>
         </Link>
      </div>
