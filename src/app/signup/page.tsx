        ...
        <div className="bg-white p-8 md:p-10 rounded-[32px] shadow-xl shadow-black/5 w-full max-w-lg border border-slate-100">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <Button 
              ...
              className="w-full text-base py-6 rounded-xl font-bold bg-white border-2 border-slate-200 text-slate-800 hover:bg-slate-50 flex items-center justify-center gap-3 transition-all mb-4 shadow-none"
            >
