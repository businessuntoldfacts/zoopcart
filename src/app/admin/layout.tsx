    ...
    <div className="flex h-screen bg-slate-50 text-slate-900 overflow-hidden font-sans">
      ...
      <aside className="w-[260px] flex-col bg-[#0F172A] text-slate-300 hidden md:flex shrink-0">
        ...
        <div className="p-4 mt-auto">
          <Link href="/admin/login" className="flex w-full items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-400 hover:bg-white/10 hover:text-red-400 transition-colors">
