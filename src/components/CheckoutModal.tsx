  ...
  return (
    <>
      <Button 
        ...
        className="flex-1 h-14 rounded-2xl bg-[#111111] hover:bg-black text-white text-base font-extrabold shadow-md w-full"
      >
              ...
              <div className="flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 overflow-y-auto">
                  <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl mb-6 border border-slate-100">
                    ...
                    <div>
                      ...
                      <div className="font-extrabold text-[#111111]">₹{product.price}</div>
                    </div>
                  </div>
                  ...
                  <form id="checkout-form" onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full h-12 px-4 rounded-xl border border-slate-200 outline-none focus:border-[#111111] focus:ring-2 focus:ring-[#111111]/20 font-medium transition-all"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        className="w-full h-24 p-4 rounded-xl border border-slate-200 outline-none focus:border-[#111111] focus:ring-2 focus:ring-[#111111]/20 font-medium resize-none transition-all"
                      />
                    </div>
                  </form>
                </div>
                ...
                <div className="p-6 border-t border-slate-100 bg-white sticky bottom-0">
                  <Button 
                    ...
                    form="checkout-form"
                    disabled={loading}
                    className="w-full h-14 rounded-2xl bg-[#111111] hover:bg-black text-white font-extrabold text-base shadow-xl shadow-black/20"
                  >
