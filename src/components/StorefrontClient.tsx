    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-24 relative">
      ...
      <header className="fixed top-0 w-full z-50 flex items-center justify-between px-4 h-14 bg-white/10 backdrop-blur-md">
        ...
        <div className="flex items-center gap-1">
          <img src="/logo.png?v=2" alt="Zoopcart" className="h-6 object-contain" />
        </div>
        <button onClick={() => {
            if (navigator.share) {
              navigator.share({
          ...
          <div className="absolute -top-12 w-24 h-24 rounded-full p-1 bg-white shadow-md">
            <div className="w-full h-full rounded-full overflow-hidden bg-slate-100 border border-slate-100 relative">
              {business.profile_image ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-indigo-50 text-indigo-600 font-extrabold text-3xl">
