...
code = code.replace('bg-white/20 text-white backdrop-blur-sm transition-colors hover:bg-white/30', 'bg-slate-50 text-slate-600 transition-colors hover:bg-slate-100');
code = code.replace('bg-white/20 text-white backdrop-blur-sm transition-colors hover:bg-white/30', 'bg-slate-50 text-slate-600 transition-colors hover:bg-slate-100');
